...
<div <?php generate_do_element_classes( 'footer' ); ?>>
    ...
    <div class="container-fluid footer-top-container" style="background-image: url('<?php the_field( 'footer_top_background_image' ); ?>')">
        <div class="container">
            <h2 class="footer-top-heading text-uppercase"><?php the_field( 'footer_top_heading' ); ?></h2>
        </div>
    </div>
